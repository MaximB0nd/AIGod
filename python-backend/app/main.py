...
def init_default_agents(db: Session):
    ...
    agents_data = [
        {"name": "Копатыч", "personality": "Добродушный медведь-огородник...", "avatar_url": None},
        {"name": "Гарри Поттер", "personality": "Молодой волшебник...", "avatar_url": None},
        {"name": "Шерлок Холмс", "personality": "Гениальный сыщик...", "avatar_url": None},
        {"name": "Харли Квинн", "personality": "Эксцентричная...", "avatar_url": None},
        {"name": "Мейбл", "personality": "Восторженная...", "avatar_url": None},
        {"name": "Маргарет Тэтчер", "personality": "«Железная леди»...", "avatar_url": None},
    ]
