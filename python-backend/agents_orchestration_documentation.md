...
├── strategies/
│   ├── __init__.py
│   ├── circular.py                        # Циркулярная стратегия (базовая)
│   ├── circular_with_narrator_summarizer.py # Циркулярная + Рассказчик + Суммаризатор
...
Стратегии оркестрации
1. Циркулярная с Рассказчиком и Суммаризатором (CircularWithNarratorSummarizerStrategy) — по умолчанию для `circular`

Агенты общаются по кругу. В каждом чате автоматически участвуют Рассказчик (🎭) и Суммаризатор (📊).

Особенности:

    Агенты отвечают последовательно

    Рассказчик — описывает сцену, атмосферу (каждые N сообщений)

    Суммаризатор — структурированная сводка после каждого раунда (Main ideas, Agreements, Points of contention, Questions, Suggestions)

    Система — объявление «Раунд X завершён»

    До 50 раундов

2. Циркулярная стратегия (CircularStrategy)

Базовая версия без Рассказчика/Суммаризатора.

3. Стратегия с рассказчиком (NarratorStrategy)
