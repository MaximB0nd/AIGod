...
├─────────────────────────────────────────────────────────────────────────┤
│  Оркестрация (при type≠single)  │  Память (ChromaDB), Граф отношений      │
│  • Circular / Narrator /       │  • Обновляются при каждом сообщении     │
│    FullContext                 │                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
## 6. Изменения (актуальная версия)

### 6.1 Агенты больше не теряют фокус на запросе
